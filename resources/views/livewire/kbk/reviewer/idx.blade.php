<div>
    ...
    <div class="row">
        <div class="card" style="left:8px;width:30%;height:30%">
          <div class="card-body">
          <div>E4051.1900255</div> 
          <div>Elektronika Industri PTE</div>
          <div>Wili Wiliana</div>
          </div>
        </div>
        <br>
        ...
        <div class="card" style="left:8px;width:66.5%">
            <div class="card-header" style="background-color:rgba(18, 167, 167, 0.825); color:#ffff">
                <div><b>Proposal</b> (Event Type)</div> 
                <div style="font-style:italic">(Status Review)</div>
                <div><b><u>(Judul Penelitian)</u></b></div>
                <div>(informasi file)</div>
                <br>
                <br>
                <div>created at</div>
                <div>updated at</div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div style="width:1%"></div>
                    <div><button style="background-color: rgba(7, 131, 177, 0.874);color:#ffff"><b>Presentation</b></button></div>
